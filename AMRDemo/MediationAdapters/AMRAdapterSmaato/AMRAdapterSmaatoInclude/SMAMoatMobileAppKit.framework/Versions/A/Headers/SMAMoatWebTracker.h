 ...
 */
@interface SMAMoatWebTracker : SMAMoatBaseTracker
 ...
 * @return SMAMoatWebTracker instance
 */
+ (SMAMoatWebTracker *)trackerWithWebComponent:(UIView *)webViewOrWebViewContainer;
...
+ (SMAMoatWebTracker *)trackerWithAdView:(UIView *)adView withWebComponent:(UIView *)webViewOrWebViewContainer;
