...
@interface SMAMoatOptions : NSObject<NSCopying>
...
@interface SMAMoatAnalytics : NSObject
 ...
 * @see SMAMoatOptions
 */
- (void)startWithOptions:(SMAMoatOptions *)options;
 ...
 * @see SMAMoatVideoTracker.h for more detail on what constitues a native ad.
 *
