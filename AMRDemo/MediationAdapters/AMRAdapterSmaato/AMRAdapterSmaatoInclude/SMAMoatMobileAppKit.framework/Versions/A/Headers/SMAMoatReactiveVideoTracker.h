...
#import "SMAMoatAdEvent.h"
#import "SMAMoatBaseTracker.h"

typedef enum SMAMoatTrackerState : NSUInteger {
 ...
 *
 */
@interface SMAMoatReactiveVideoTracker : SMAMoatBaseTracker

@property (readonly) SMAMoatTrackerState state;
 ...
 * @return SMAMoatReactiveVideoTracker instance
 */
+ (SMAMoatReactiveVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
 ...
 *
 * @see SMAMoatAdEvent to see the required video ad events that must be reported to the SDK if they occur
 */
- (void)dispatchEvent:(SMAMoatAdEvent *)event;
